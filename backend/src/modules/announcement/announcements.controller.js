  ...
  return res
    ...
    .json(
      new ApiResponse(
        201,
        announcements,
        "New Announcement create successfully",
      ),
    );
});
...
const getAllAnnouncements = asyncHandler(async (req, res) => {
  ...
  return res
    .status(200)
    .json(new ApiResponse(200, allAnnouncement, "fetch all announcements"));
});
...
const deleteAnnouncement = asyncHandler(async (req, res) => {
  ...
  return res
    .status(204)
    .json(new ApiResponse(204, {}, "Announcement Delete successfully"));
});
