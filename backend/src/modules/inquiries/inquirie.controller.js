import Inquirie from "./inquirie.model.js";
...
const newInquirie = asyncHandler(async (req, res) => {
  ...
  return res
    .status(201)
    .json(new ApiResponse(201, newInquirie, "send Inquirie"));
});
...
const getInquiries = asyncHandler(async (req, res) => {
  ...
  */
  ...
  return res
    .status(200)
    .json(new ApiResponse(200, inquiries, "fetch all inquiries successfully"));
});
...
const deleteInquirie = asyncHandler(async (req, res) => {
  ...
  return res
    .status(200)
    .json(new ApiResponse(200, {}, "Inquirie deleted successfully"));
});

export { deleteInquirie, getInquiries, newInquirie, updateInquirie };
