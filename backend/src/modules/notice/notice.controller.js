...
const newNotice = asyncHandler(async (req, res) => {
  ...
  if (
    [title, category, content, date].some(
  ...
  return res
    .status(201)
    .json(new ApiResponse(201, {}, "New Notice posted successfully"));
});
...
const getAllNotice = asyncHandler(async (req, res) => {
  ...
  return res
    .status(200)
    .json(new ApiResponse(200, allNotice, "Notice fetch Succesfully"));
});
...
const deleteNotice = asyncHandler(async (req, res) => {
  ...
  return res
    .status(200)
    .json(new ApiResponse(200, {}, "notice delete successfully"));
});

export { deleteNotice, getAllNotice, newNotice, updateNotice };
